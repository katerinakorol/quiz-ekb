...

{
...

    {
      ...
      options: [
        ...
        {text: 'Парой катеров', feedback: 'В середине 50-х по Шарташу начали курсировать два пассажирских катера, первые четыре года они находились в «трамвайном» ведомстве.', is_right:true},
        {text: 'Воздушным шаром', feedback: 'Звучит здорово, но нет. В середине 50-х по Шарташу начали курсировать два пассажирских катера — первые четыре года они находились в «трамвайном» ведомстве.', is_right:false}
      ]
    }
  ];
