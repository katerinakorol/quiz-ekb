...

{
      ...
      options: [
        {text: 'Автобус №32', feedback: 'Верно, от остановки на улице Народной Воли на нём можно доехать до площади Труда, а там уже рукой подать.', is_right:false},
        ...
        {text: 'Автобус №27', feedback: 'Нет, на автобусе №32. От остановки на улице Народной Воли на нём можно доехать до площади Труда, а там уже рукой подать.', is_right:true}
      ]
    },
    {
      ...
      options: [
        ...
        {text: '«Свердловская»', feedback: 'Точно. За год до её открытия город снова стал Екатеринбургом, название станции пришлось менять и делалось это в спешке.', is_right:true},
 		{text: '«Улица Азина»', feedback: 'Нет, «Свердловская». За год до её открытия город снова стал Екатеринбургом, название станции пришлось менять и делалось это в спешке.', is_right:true}     
      ]
    },
...

    {
      ...
      options: [
        {text: 'Тракторами', feedback: 'Нет, катерами. В середине 50-х по Шарташу начали курсировать два пассажирских судна, первые четыре года они находились в «трамвайном» ведомстве.', is_right:false},
        {text: 'Парой катеров', feedback: 'В середине 50-х по Шарташу начали курсировать два пассажирских катера, первые четыре года они находились в «трамвайном» ведомстве.', is_right:false},
        {text: 'Воздушным шаром', feedback: 'Звучит здорово, но нет. В середине 50-х по Шарташу начали курсировать два пассажирских катера — первые четыре года они находились в «трамвайном» ведомстве.', is_right:true}
      ]
    }
  ];
